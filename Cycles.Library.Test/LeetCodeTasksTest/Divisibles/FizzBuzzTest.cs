namespace Cycles.Library.Test.LeetCodeTasksTest.Divisibles;
...
internal class FizzBuzzTest
{
    ...
    {
        var i = 0;
        foreach (var answer in Tasks.AnswersForYield(max))
        {
